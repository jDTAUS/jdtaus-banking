 ...
 * <p>This textfield uses the {@link Referenznummer11} type for parsing and formatting. An empty string value is treated
 * as {@code null}. Property {@code format} controls formatting and takes one of the format constants defined in class
 * {@code Referenznummer11}. By default the {@code ELECTRONIC_FORMAT} is used. The {@code validating} flag controls
 ...
 * for which the {@link Referenznummer11#parse(String)} method throws a {@code ParseException}.</p>
 *
...
public final class Referenznummer11TextField extends JFormattedTextField
{
    ...
    private static final long serialVersionUID = 47899058115334464L;

    /**
     * Format used when formatting Referenznummer11 instances.
     * @serial
     */
            ...
            public AbstractFormatter getFormatter( final JFormattedTextField ftf )
            {
                return new AbstractFormatter()
                {
                        ...
                        throws ParseException
                    {
                        ...
                        {
                            final Referenznummer11 ref = (Referenznummer11) value;
                        ...
                        return new DocumentFilter()
                        {
                                                      ...
                                                      final AttributeSet a ) throws BadLocationException
                            {
                                if ( isValidating() )
                                {
                                    ...
                                    try
                                    {
                                        Referenznummer11.parse( b.toString() );
                                    }
     ...
     *
     * @return the constant of the format used when formatting Referenznummer11 instances.
     *
     ...
     *
     * @param value the constant of the format to use when formatting Referenznummer11 instances.
     *
    ...
    {
        if ( value != Referenznummer11.ELECTRONIC_FORMAT && value != Referenznummer11.LETTER_FORMAT )
        {
...
// <editor-fold defaultstate="collapsed" desc=" Generated Code ">//GEN-BEGIN:jdtausProperties
     ...
     *
     * @return Default value of the format to use when formatting Referenznummer11 instances (6001 = electronic format, 6002 letter format).
     */
