    ...
    implements CurrencyDirectory, ContainerInitializer
{
    ...
    protected void initializeProperties(final Properties meta)
    {
        ...
        p = meta.getProperty("propertiesResource");
    ...
    /**
     * Gets the value of property <code>propertiesResource</code>.
     *
     * @return the value of property <code>propertiesResource</code>.
     */
