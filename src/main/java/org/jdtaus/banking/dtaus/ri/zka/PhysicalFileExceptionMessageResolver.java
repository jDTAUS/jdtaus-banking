...
// <editor-fold defaultstate="collapsed" desc=" Generated Code ">//GEN-BEGIN:jdtausImplementation
    ...
    private static final Implementation META =
        ...
        getImplementation(PhysicalFileExceptionMessageResolver.class.getName());
...
// <editor-fold defaultstate="collapsed" desc=" Generated Code ">//GEN-BEGIN:jdtausConstructors
    ...
    /**
     * <code>PhysicalFileExceptionMessageResolver</code> implementation constructor.
     *
     * @param meta Implementation meta-data.
     *
     * @throws NullPointerException if <code>meta</code> is <code>null</code>.
     */
    private PhysicalFileExceptionMessageResolver(final Implementation meta)
    {
        super();
        if(meta == null)
        {
    ...
    /**
     * <code>PhysicalFileExceptionMessageResolver</code> dependency constructor.
     *
     * @param meta dependency meta-data.
     *
     * @throws NullPointerException if <code>meta</code> is <code>null</code>.
     */
    private PhysicalFileExceptionMessageResolver(final Dependency meta)
    {
        super();
        if(meta == null)
        {
