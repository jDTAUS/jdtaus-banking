        ...
        final ByteBuffer buf )
    {
        ...
        while ( in.hasRemaining() )
        {
            ...
            for ( i = 0; i < inLen; i++ )
            {
                ...
                buf.put( IBM273CharsetProvider.CHAR_TO_IBM273[this.charBuf[i]] );
        ...
        final ByteBuffer buf )
    {
        ...
        while ( ( inRemaining = in.remaining() ) > 0 )
        {
            ...
            for ( int i = 0; i < inRemaining; i++ )
            {
                ...
                {
                    outArray[outIndex] =
                        IBM273CharsetProvider.CHAR_TO_IBM273[inArray[inIndex]];
        ...
        final CharBuffer buf )
    {
        ...
        while ( in.hasRemaining() )
        {
            ...
            for ( i = 0; i < inLen; i++ )
            {
                ...
                buf.put( IBM273CharsetProvider.IBM273_TO_CHAR[this.byteBuf[i] &
                    0xFF] );
        ...
        final CharBuffer buf )
    {
        ...
        while ( ( inRemaining = in.remaining() ) > 0 )
        {
            for ( int i = 0; i < inRemaining; i++ )
            {
                ...
                final int outIndex = outPosition + outOffset + i;
                outArray[outIndex] =
                IBM273CharsetProvider.IBM273_TO_CHAR[inArray[inIndex] & 0xFF];
