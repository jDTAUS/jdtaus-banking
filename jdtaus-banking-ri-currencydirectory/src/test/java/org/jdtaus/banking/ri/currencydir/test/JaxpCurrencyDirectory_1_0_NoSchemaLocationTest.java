 ...
 * @version $Id$
 */
public class JaxpCurrencyDirectory_1_0_NoSchemaLocationTest extends AbstractJaxpCurrencyDirectoryTest
{
    ...
    protected ClassLoader getClassLoader()
    {
        ...
        cl.addResources( "META-INF/jdtaus/currencies.xml", new URL[]
            {
                this.getClass().getResource( "currencies-no-schemalocation-1.0.xml" )
            } );
