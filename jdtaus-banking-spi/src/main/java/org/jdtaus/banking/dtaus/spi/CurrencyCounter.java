...
/**
 * Utility class for maintaining a mapping of currencies to corresponding
 * counters.
 *
 * <p><b>Note:</b><br/>This class is not synchronized and must not be used
...
public class CurrencyCounter implements Serializable
{
    ...
    public Currency[] getCurrencies()
    {
        ...
        for ( Iterator it = this.getCurrencyMap().entrySet().
            iterator(); it.hasNext(); )
        {
        ...
        return (Currency[]) currencies.toArray(
            new Currency[ currencies.size() ] );
    }
    ...
    public long getValue( final Currency currency )
    {
        ...
        final Long value = (Long) this.getCurrencyMap().get(
     ...
     *
     * @throws NullPointerException if {@code currency} is {@code null}.
     * @throws IndexOutOfBoundsException if the value of the counter of
     * {@code currency} is equal to {@link Long#MAX_VALUE}.
     */
    public void add( final Currency currency )
    {
        ...
        this.getCurrencyMap().put( currency.getCurrencyCode(),
            new Long( value + 1L ) );
     ...
     * @throws NullPointerException if {@code currency} is {@code null}.
     * @throws IndexOutOfBoundsException if the value of the counter of
     * {@code currency} is equal to zero.
     */
