 ...
 * @version $JDTAUS$
 */
public class JaxpTextschluesselVerzeichnis_1_2_NoSchemaLocationTest extends AbstractJaxpTextschluesselVerzeichnisTest
{
    ...
    protected ClassLoader getClassLoader()
    {
        ...
        {
            this.getClass().getResource( "textschluessel-no-schemalocation-1.2.xml" )
        } );
