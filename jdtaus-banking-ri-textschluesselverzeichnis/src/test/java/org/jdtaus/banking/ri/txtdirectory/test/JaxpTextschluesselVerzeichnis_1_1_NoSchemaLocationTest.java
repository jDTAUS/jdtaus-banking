 ...
 * @version $Id$
 */
public class JaxpTextschluesselVerzeichnis_1_1_NoSchemaLocationTest extends AbstractJaxpTextschluesselVerzeichnisTest
{
    ...
    protected ClassLoader getClassLoader()
    {
        ...
        cl.addResources( "META-INF/jdtaus/textschluessel.xml", new URL[]
            {
                this.getClass().getResource( "textschluessel-no-schemalocation-1.1.xml" )
            } );
